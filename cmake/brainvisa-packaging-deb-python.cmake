...
function( BRAINVISA_PACKAGING_RUN pack_type dependency_type component component_pack_type version_ranges binary_independent )
  ...
  list( FIND BRAINVISA_EXTERNAL_COMPONENTS "${BRAINVISA_PACKAGE_NAME}" result )
  if( result EQUAL -1 )
    set( BRAINVISA_EXTERNAL_COMPONENTS ${BRAINVISA_EXTERNAL_COMPONENTS} "${BRAINVISA_PACKAGE_NAME}" CACHE STRING INTERNAL FORCE )
...
function( BRAINVISA_PACKAGING_DEV pack_type dependency_type component component_pack_type version_ranges binary_independent )
  ...
  list( FIND BRAINVISA_EXTERNAL_COMPONENTS "${BRAINVISA_PACKAGE_NAME}-dev" result )
  if( result EQUAL -1 )
    set( BRAINVISA_EXTERNAL_COMPONENTS ${BRAINVISA_EXTERNAL_COMPONENTS} "${BRAINVISA_PACKAGE_NAME}-dev" CACHE STRING INTERNAL FORCE )
