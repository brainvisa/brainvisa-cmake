...
function( BRAINVISA_PACKAGING_COMPONENT_RUN component )
  if(QT_QTSVG_FOUND)
    if(CMAKE_BUILD_TYPE STREQUAL "Debug" AND QT_QTSVG_LIBRARY_DEBUG)
      set(libs ${QT_QTSVG_LIBRARY_DEBUG})
    else()
      set(libs ${QT_QTSVG_LIBRARY_RELEASE})
    endif()
...
set( libqt4-svg-dev-installrule TRUE )

function( BRAINVISA_PACKAGING_COMPONENT_DEV component )
  if(QT_QTSVG_FOUND)
    BRAINVISA_INSTALL_DIRECTORY( "${QT_QTSVG_INCLUDE_DIR}" include/qt4/QtSvg
      ${component}-dev )
