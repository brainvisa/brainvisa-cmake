...
function( BRAINVISA_PACKAGING_COMPONENT_RUN component )
  if(QT_QTXML_FOUND)
    if(CMAKE_BUILD_TYPE STREQUAL "Debug" AND QT_QTXML_LIBRARY_DEBUG)
      set(libs ${QT_QTXML_LIBRARY_DEBUG})
    else()
      set(libs ${QT_QTXML_LIBRARY_RELEASE})
    endif()
...
set( libqt4-xml-dev-installrule TRUE )

function( BRAINVISA_PACKAGING_COMPONENT_DEV component )
  if(QT_QTXML_FOUND)
    BRAINVISA_INSTALL_DIRECTORY( "${QT_QTXML_INCLUDE_DIR}" include/qt4/QtXml
      ${component}-dev )
