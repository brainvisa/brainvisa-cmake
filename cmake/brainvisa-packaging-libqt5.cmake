...
function( BRAINVISA_PACKAGING_COMPONENT_INFO component package_name package_maintainer package_version )
  ...
  BRAINVISA_THIRDPARTY_DEPENDENCY( "${component}" RUN DEPENDS libqt5gui RUN ">= ${QT_VERSION}" )
  BRAINVISA_THIRDPARTY_DEPENDENCY( "${component}" RUN DEPENDS libqt5widgets RUN ">= ${QT_VERSION}" )
  BRAINVISA_THIRDPARTY_DEPENDENCY( "${component}" RUN DEPENDS libqt5opengl RUN ">= ${QT_VERSION}" )
  BRAINVISA_THIRDPARTY_DEPENDENCY( "${component}" RUN RECOMMENDS libqt5network RUN ">= ${QT_VERSION}" )
  ...
  BRAINVISA_THIRDPARTY_DEPENDENCY( "${component}" "${component}" RUN RECOMMENDS libqt5webkitwidgets RUN )
  ...
  BRAINVISA_THIRDPARTY_DEPENDENCY( "${component}" RUN RECOMMENDS libqt5xmlpatterns RUN ">= ${QT_VERSION}" )
...
function( BRAINVISA_PACKAGING_COMPONENT_DEV component )
  if(Qt5Widgets_FOUND)
    ...
    BRAINVISA_THIRDPARTY_DEPENDENCY( "${component}" DEV DEPENDS libqt5opengl DEV )
    BRAINVISA_THIRDPARTY_DEPENDENCY( "${component}" DEV RECOMMENDS libqt5network DEV )
    BRAINVISA_THIRDPARTY_DEPENDENCY( "${component}" DEV RECOMMENDS libqt5sql DEV )
    BRAINVISA_THIRDPARTY_DEPENDENCY( "${component}" DEV RECOMMENDS libqt5multimedia DEV )
    BRAINVISA_THIRDPARTY_DEPENDENCY( "${component}" DEV RECOMMENDS libqt5multimediawidgets DEV )
    BRAINVISA_THIRDPARTY_DEPENDENCY( "${component}" DEV RECOMMENDS libqt5webkit DEV )
    BRAINVISA_THIRDPARTY_DEPENDENCY( "${component}" DEV RECOMMENDS libqt5webkitwidgets DEV )
    BRAINVISA_THIRDPARTY_DEPENDENCY( "${component}" DEV RECOMMENDS libqt5svg DEV )
    BRAINVISA_THIRDPARTY_DEPENDENCY( "${component}" DEV RECOMMENDS libqt5xml DEV )
    BRAINVISA_THIRDPARTY_DEPENDENCY( "${component}" DEV RECOMMENDS libqt5xmlpatterns DEV )
