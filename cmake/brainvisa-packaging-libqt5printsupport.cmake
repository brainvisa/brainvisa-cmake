...
function( BRAINVISA_PACKAGING_COMPONENT_RUN component )
  if(Qt5PrintSupport_FOUND)
    set( libs )
    foreach( _lib ${Qt5PrintSupport_LIBRARIES})
      # get lib file
    ...
    # install plugins
    set( _plugins_dir )
    foreach( plugin ${Qt5PrintSupport_PLUGINS} )
...
set( libqt5printsupport-dev-installrule TRUE )

function( BRAINVISA_PACKAGING_COMPONENT_DEV component )
  if(Qt5PrintSupport_FOUND)
    foreach( _include ${Qt5PrintSupport_INCLUDE_DIRS} )
      get_filename_component( _name ${_include} NAME )
      if( _name STREQUAL "QtPrintSupport" )
