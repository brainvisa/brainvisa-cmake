...
function( BRAINVISA_PACKAGING_COMPONENT_RUN component )
  if(Qt5Sql_FOUND)
    ...
    if( _plugins_dir )
      ...
      # Qt5Sql_PLUGINS is empty
      get_filename_component( _dir ${libs} PATH )
      set( _plugins_dir "${_dir}/qt5/plugins" )
      if( EXISTS ${_plugins_dir} )
        if( EXISTS "${_plugins_dir}/sqldrivers" )
          BRAINVISA_INSTALL( DIRECTORY "${_plugins_dir}/sqldrivers"
...
set( libqt5sql-dev-installrule TRUE )

function( BRAINVISA_PACKAGING_COMPONENT_DEV component )
  if(Qt5Sql_FOUND)
    foreach( _include ${Qt5Sql_INCLUDE_DIRS} )
      get_filename_component( _name ${_include} NAME )
      if( _name STREQUAL "QtSql" )
