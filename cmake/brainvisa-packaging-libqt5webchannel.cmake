...
function( BRAINVISA_PACKAGING_COMPONENT_RUN component )
  if(Qt5WebChannel_FOUND)
    set( libs )
    foreach( _lib ${Qt5WebChannel_LIBRARIES})
      # get lib file
    ...
    # install plugins
    set( _plugins_dir )
    foreach( plugin ${Qt5WebChannel_PLUGINS} )
...
set( libqt5webchannel-dev-installrule TRUE )

function( BRAINVISA_PACKAGING_COMPONENT_DEV component )
  if(Qt5WebChannel_FOUND)
    foreach( _include ${Qt5WebChannel_INCLUDE_DIRS} )
      get_filename_component( _name ${_include} NAME )
      if( _name STREQUAL "QtWebChannel" )
