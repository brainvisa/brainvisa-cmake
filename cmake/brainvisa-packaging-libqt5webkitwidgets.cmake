...
function( BRAINVISA_PACKAGING_COMPONENT_INFO component package_name package_maintainer package_version )
  ...
  BRAINVISA_THIRDPARTY_DEPENDENCY( "${component}" RUN DEPENDS libqt5printsupport RUN )
endfunction()

function( BRAINVISA_PACKAGING_COMPONENT_RUN component )
  if(Qt5WebKitWidgets_FOUND)
    set( libs )
    foreach( _lib ${Qt5WebKitWidgets_LIBRARIES})
      # get lib file
    ...
    # install plugins
    set( _plugins_dir )
    foreach( plugin ${Qt5WebKitWidgets_PLUGINS} )
...
set( libqt5webkitwidgets-dev-installrule TRUE )

function( BRAINVISA_PACKAGING_COMPONENT_DEV component )
  if(Qt5WebKitWidgets_FOUND)
    foreach( _include ${Qt5WebKitWidgets_INCLUDE_DIRS} )
      get_filename_component( _name ${_include} NAME )
      if( _name STREQUAL "QtWebKitWidgets" )
