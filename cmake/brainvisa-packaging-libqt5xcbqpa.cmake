...
function( BRAINVISA_PACKAGING_COMPONENT_INFO component package_name package_maintainer package_version )
  ...
  BRAINVISA_THIRDPARTY_DEPENDENCY( "${component}" RUN DEPENDS libqt5dbus RUN )
  if( UNIX AND NOT APPLE )
    BRAINVISA_THIRDPARTY_DEPENDENCY( "${component}" RUN DEPENDS libxkbcommon-x11 RUN )
  endif()
endfunction()
