...
function( BRAINVISA_PACKAGING_COMPONENT_RUN component )
  if(Qt5XmlPatterns_FOUND)
    set( libs )
    foreach( _lib ${Qt5XmlPatterns_LIBRARIES})
      # get lib file
    ...
    # install plugins
    set( _plugins_dir )
    foreach( plugin ${Qt5XmlPatterns_PLUGINS} )
...
set( libqt5xmlpatterns-dev-installrule TRUE )

function( BRAINVISA_PACKAGING_COMPONENT_DEV component )
  if(Qt5XmlPatterns_FOUND)
    if( NOT Qt5XmlPatterns_INCLUDE_DIRS )
      # bug in qt5 install, at least on ubuntu 16.04
      set( _incdirs ${Qt5Core_INCLUDE_DIRS} )
    else()
      set( _incdirs ${Qt5XmlPatterns_INCLUDE_DIRS} )
    endif()
    foreach( _include ${_incdirs} )
      get_filename_component( _name ${_include} NAME )
      if( _name STREQUAL "QtXmlPatterns" OR
          _name STREQUAL "QtCore" )
        get_filename_component( _path ${_include} PATH )
        BRAINVISA_INSTALL_DIRECTORY( "${_path}/QtXmlPatterns"
          include/qt5/QtXmlPatterns
          ${component}-dev )
      endif()
    endforeach()
