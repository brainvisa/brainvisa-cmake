...
function( BRAINVISA_PACKAGING_COMPONENT_RUN component )
  execute_process( COMMAND ${PYTHON_HOST_EXECUTABLE} -c "from __future__ import print_function; import spur, os; print(os.path.dirname(spur.__file__))" OUTPUT_VARIABLE spur_directory OUTPUT_STRIP_TRAILING_WHITESPACE )
  if( spur_directory )
