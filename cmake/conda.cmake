...
set(CMAKE_EXE_LINKER_FLAGS "-Wl,--enable-new-dtags -L${CMAKE_BINARY_DIR}/lib -L$ENV{CONDA_PREFIX}/lib")
...
include_directories(BEFORE "$CASA/include" "$ENV{CONDA_PREFIX}/include" "$ENV{CONDA_PREFIX}/mesalib/include")
