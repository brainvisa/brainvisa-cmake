...
ELSE(EXISTS Sigc++2_INCLUDE_DIR)
  ...
  ELSE(FC_FOUND)
    ...
    IF(WIN32 AND NOT FontConfig_FOUND)
      BRAINVISA_FIND_FSENTRY( FontConfig_LIBRARIES PATTERNS "libfontconfig*" PATHS $ENV{PATH} )
      IF(FontConfig_LIBRARIES)
        GET_FILENAME_COMPONENT( result "${FontConfig_LIBRARIES}" PATH )
        SET( result "${result}/../include" )
        FIND_PATH( FontConfig_INCLUDE_DIR fontconfig/fontconfig.h  PATHS "${result}" )
