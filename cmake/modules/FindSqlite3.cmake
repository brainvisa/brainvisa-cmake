...
if( SQLITE3_VERSION )
  ...
  if( SQLITE3_EXECUTABLE )
    ...
    execute_process( COMMAND ${SQLITE3_EXECUTABLE} -version OUTPUT_VARIABLE SQLITE3_VERSION OUTPUT_STRIP_TRAILING_WHITESPACE )
    set( SQLITE3_VERSION "${SQLITE3_VERSION}" CACHE STRING "Version of sqlite3 executable" )
