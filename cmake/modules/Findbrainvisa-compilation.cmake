...
function( BRAINVISA_READ_COMPONENT_INFOS )
  ...
  foreach( info ${projects_info} )
    get_filename_component( sourcesPA_dir "${info}" PATH )
...
if( NOT DEFINED BRAINVISA_SOURCES OR 
  ...
  set( BRAINVISA_SOURCES "$ENV{BRAINVISA_SOURCES}" CACHE PATH "Directories where to look for sources." )
...
if( NOT BRAINVISA_PROJECTS OR NOT "${BRAINVISA_PROJECTS}" STREQUAL "${_BRAINVISA_PROJECTS}" )
  ...
  if( DEFINED ENV{BRAINVISA_PROJECTS} )
    set( BRAINVISA_PROJECTS $ENV{BRAINVISA_PROJECTS} CACHE STRING "List of main BrainVISA projects to build." )
  else()
