            ...
            for dcomponent in dependencies:
                if isinstance(dcomponent, basestring):
                    ...
                    if dcomponent in self.build_directory.components:
                        ...
                        print >> sys.stderr, 'WARNING: component %s declares a dependency on %s in its info.py but build directory does not contains %s' % (self.component_name, dcomponent, dcomponent)
                        d['version'] = 'unknown'
