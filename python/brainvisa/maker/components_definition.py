...
components_definition = [
    ('development', {
        'components': [
            ['brainvisa-cmake', {
                'groups': ['all', 'anatomist', 'opensource', 'standard', 'catidb_server', 'catidb3_all', 'cati_platform'],
                'branches': {
            ...
            ['brainvisa-svn', {
                'groups': ['all', 'opensource', 'standard', 'catidb_server', 'catidb3_all', 'cati_platform'],
                'branches': {
