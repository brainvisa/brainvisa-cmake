...
class PackCommand(brainvisa.maker.commands.StepCommand):
...
class InstallPackCommand(brainvisa.maker.commands.StepCommand):
...
class TestPackCommand(brainvisa.maker.commands.StepCommand):
...
class TestrefPackCommand(brainvisa.maker.commands.StepCommand):
...
class PublishPackCommand(brainvisa.maker.commands.StepCommand):
